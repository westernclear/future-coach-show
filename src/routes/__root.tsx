...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "CoachFace" },
      { title: "CoachFace" },
      { name: "description", content: "The multi-sport fantasy game where coaching decisions count." },
      { name: "author", content: "CoachFace" },
      { property: "og:title", content: "CoachFace" },
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", sizes: "192x192", href: "/coachface-icon-192.png" },
      { rel: "apple-touch-icon", sizes: "192x192", href: "/coachface-icon-192.png" },
    ],
  }),
