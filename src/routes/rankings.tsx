      ...
      <main className="mx-auto max-w-7xl px-5 py-12 lg:px-8 lg:py-16">
        <section className="grid border-y border-border lg:grid-cols-[1.35fr_1fr_1fr]" aria-label="Power ranking leaders">
          <div className="border-b border-border py-7 lg:border-b-0 lg:border-r lg:pr-8">
            ...
            <div className="mt-4 flex min-w-0 items-center gap-4 sm:gap-5"><span className="grid size-16 shrink-0 place-items-center rounded-full bg-primary font-display text-xl font-black text-primary-foreground">AR</span><div className="min-w-0"><h2 className="font-display text-3xl font-black uppercase">Andy Reid</h2><p className="break-words text-sm text-muted-foreground">NFL Football · Kansas City Chiefs</p></div></div>
          </div>
        ...
        <div className="mt-8 border-t border-border">
          {visible.map((coach) => (
            <article key={coach.name} className="grid items-center gap-4 border-b border-border py-6 sm:grid-cols-[64px_1fr_auto_auto]">
              ...
              <div className="flex min-w-0 items-center gap-4"><span className="grid size-12 shrink-0 place-items-center rounded-full bg-secondary font-display font-black">{coach.initials}</span><div className="min-w-0"><h2 className="font-bold">{coach.name}</h2><p className="break-words text-sm text-muted-foreground">{coach.sport} · {coach.role}</p><p className="mt-2 max-w-xl text-sm leading-relaxed text-muted-foreground">{coach.reason}</p></div></div>
